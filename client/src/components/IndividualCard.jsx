...
function IndividualCards({ individuals, individualDeleted }) {
  return (
      ...
      {individuals.map((individual) => (
        <div key={"individual.id"} className="relative bg-yellow-300 rounded-lg p-4">
          ...
          <button
            onClick={() => {
              // if (speciesDeleted) {
                individualDeleted(individual.id);
              // }
            }}
          ...
          <p><span className="underline font-bold">Individual ID:</span>  {individual.id}</p>
